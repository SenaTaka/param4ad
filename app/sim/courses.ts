...
// ── Venue: 実会場コース（スタート→S字→試験カーブ→Uターン→ゴール）────────────
// 会場図面のトポロジーを再現した point-to-point コース。廊下幅 2.0m。
// ルート: 右上スタート→西進→S字スラローム→中央仕切りで北へ→試験カーブ
...
const VENUE_WALLS: Wall[] = [
  ...
  // 試験カーブ・ループ x∈[6.3,10.3], y∈[0.5,5.5]
...
export const VENUE: Course = {
  id: "venue",
  name: "実コース（S字 → 試験カーブ → Uターン）",
  worldW: 17,
  worldH: 13,
  walls: VENUE_WALLS,
  floors: [
    { x: 0.5, y: 5.5, w: 16.0, h: 2.0 },   // メイン廊下
    { x: 6.3, y: 0.5, w: 4.0,  h: 5.0 },   // 試験カーブ
